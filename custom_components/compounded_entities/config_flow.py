"""Config flow for Compounded Entities integration."""
...
class CompoundedEntitiesFlowHandler(SchemaConfigFlowHandler, domain=DOMAIN):
    """Handle a config flow for Compound Time."""
